...
|:---------|:--------|---------------:|-------------:|-------------------:|------------:|
| AAPL     | rf      |       0.473499 |    0.555891  |         -0.0303046 |           6 |
| AAPL     | xgb     |       0.49627  |   -0.0114909 |         -0.0794217 |           6 |

## Production Model Selection

The selected production model is **rf** for **AAPL**.
- **Average Sharpe Ratio**: 0.5559
- **Average Accuracy**: 0.4735
- **Average Max Drawdown**: -0.0303
